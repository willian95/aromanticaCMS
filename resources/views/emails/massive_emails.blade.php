                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101;"> Tu código de descuento es: <strong>{{ $coupon['coupon_code'] }}</strong>  </span><br></p></td> 
                     </tr> 

                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#010101; text-align: justify;">Hola <strong>{{ $couponName }}</strong>, has recibido un cupón de descuento por <strong>{{ number_format($coupon['discount_amount'], 0, ",", ".") }} @if($coupon['discount_type'] == 'neto') $ @else % @endif</strong> disponible hasta la fecha <strong> {{ Carbon\Carbon::createFromFormat('Y-m-d', $coupon['end_date'])->format('d-m-Y') }} </strong> y que puede ser aplicado @if($coupon["total_discount"] == 'carrito')<strong>a todo el carrito.</strong> @else <strong>solo a los productos seleccionados debajo<strong>. @endif</span><br></p></td> 
                     </tr> 
                                ...
                                <tbody>
                                    @foreach($products as $product)
                                        ...
                                        @php
                                            ...
                                            $productInfo =  App\ProductTypeSize::with(["product", "size", "type", "product.brand"])->where("id", $product->product_type_size_id)->first();
